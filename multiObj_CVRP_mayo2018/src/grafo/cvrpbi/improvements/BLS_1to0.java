...
public class BLS_1to0 implements Improvement<WCPSolution> {
			...
			if (r1 == r2) {
				...
				if (size1 - 2 <= 0) {
					...
					if (bestP1 > 0) {
						...
						////System.out.println("movimiento 1-0: " + solution);
						nonImproved = 0;
						break;
					} else
						nonImproved++;
				...
				if (size1 - 2 <= 0) {
					...
					if (bestS > 0) {
						...
						//System.out.println("tras movimiento nueva solución = "+solution);
						nonImproved = 0;
						break;
					} else
						nonImproved++;
