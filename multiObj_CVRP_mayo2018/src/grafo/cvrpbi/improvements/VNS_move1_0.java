...
// NUEVA APROXIMACIÓN 16 Abril: shaking = mueve K nodos aleatoriamente entre rutas DISTINTAS.
public class VNS_move1_0 extends VNS{

    public VNS_move1_0(Improvement<WCPSolution>[] ls, double kStep) {
       super(ls,kStep);
    }
