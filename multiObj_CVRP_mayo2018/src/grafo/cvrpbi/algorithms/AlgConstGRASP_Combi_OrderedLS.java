...
public class AlgConstGRASP_Combi_OrderedLS implements Algorithm<WCPInstance_RealInstance> {
    ...
    public AlgConstGRASP_Combi_OrderedLS(Constructive<WCPInstance_RealInstance, WCPSolution> cCombi, Improvement<WCPSolution> ls, int iters) {
        this.c = cCombi;
        this.ls = ls;
        this.iters = iters;
    }
