...
public class AlgConstGRASP_PR_RandomLS implements Algorithm<WCPInstance_RealInstance> {
    ...
    public AlgConstGRASP_PR_RandomLS(Constructive<WCPInstance_RealInstance, WCPSolution> c1,Constructive<WCPInstance_RealInstance, WCPSolution> c2,Constructive<WCPInstance_RealInstance, WCPSolution> c3, Improvement<WCPSolution>[] ls, int iters) {
        this.c1 = c1;
        this.c2 = c2;
        this.c3 = c3;
        this.ls = ls;
